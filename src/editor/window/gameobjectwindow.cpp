...
{
    m_GameObjectListBounds = Rectangle{m_Bounds.x, m_Bounds.y, m_Bounds.width, m_Bounds.height * 0.9f};

    m_GameObjectListString = "Object1;Object2;Object3;Object4;Object5;Object6;Object7;Object8;Object9;Object10;"
    ...
    m_AddBounds = Rectangle{m_Bounds.x, buttonY, buttonWidth, buttonHeight};

    m_RemoveBounds = Rectangle{m_Bounds.x + buttonWidth, buttonY, buttonWidth, buttonHeight};

    m_MoveUpBounds = Rectangle{m_Bounds.x + 2 * buttonWidth, buttonY, buttonWidth, buttonHeight};

    m_MoveDownBounds = Rectangle{m_Bounds.x + 3 * buttonWidth, buttonY, buttonWidth, buttonHeight};
}
